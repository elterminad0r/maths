      ...
      \begin{itemize}
       \item If \(\vec a \vecdot \vec b \ne -1\)
        ...
        \item
         ...
         So \emph{if} \(\vec c \vecdot \vec a = 0\), then there could be a
         solution. In fact,  \(\vec r = \vec c\) is then a
         ...
         precisely the line
         \(\vec r = \vec c + \lambda \vec b\), though only if
         \(\vec c \vecdot \vec a = 0\).
      \end{itemize}
    \end{enumerate}
   \item
    Calculating each magnitude,
    \begin{align*}
     \abs{\vec e_r}^2 &= \cos^2 \phi \sin^2 \theta
                         + \sin^2 \phi \sin^2 \theta + \cos^2 \theta \\
                      &= (\sin^2 \phi + \cos^2 \phi)\sin^2 \theta
                         + \cos^2 \theta \\
                      &= \sin^2 \theta + \cos^2 \theta = 1 \\
     \abs{\vec e_\theta}^2 &= \cos^2 \phi \cos^2 \theta
                         + \sin^2 \phi \cos^2 \theta + \sin^2 \theta \\
                      &= (\sin^2 \phi + \cos^2 \phi)\cos^2 \theta
                         + \sin^2 \theta \\
                      &= \sin^2 \theta + \cos^2 \theta = 1 \\
     \abs{\vec e_\phi}^2 &= \sin^2 \phi + \cos^2 \phi = 1
    \end{align*}
