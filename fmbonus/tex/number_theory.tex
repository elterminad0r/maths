...
\begin{enumerate}
 ...
 \item
  ...
  coefficients.
 \item
  Show that \(\sqrt[\sqrt 2]2 = {\sqrt 2}^{\sqrt 2}\).
 \item
 ...
 \item
  ...
  Let \(p\) be a prime, and \(a \in \Integers\). Then
  \begin{equation*}
   a^p \equiv a \pmod p
  \end{equation*}
  by induction on \(a\).
 ...
 \item
  ...
  \begin{align*}
   ...
   \text{and}\quad
   M_0'(M_0'(x_1, \dotsc, x_n), M_0'(y_0, \dotsc, x_n)) &=
   M_0'(x_1, \dotsc, x_n, y_0, \dotsc, y_n)
  \end{align*}
