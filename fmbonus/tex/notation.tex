...
there's nothing in it to pick!) It is related to the principle of explosion.
...
\end{equation*}
In much that same way that a universally quantified statement over the empty set
...
The Fundamental Theorem of Calculus tells you\footnote{
